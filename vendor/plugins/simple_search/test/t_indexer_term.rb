...
class TermIndexerTest < Test::Unit::TestCase
...
#  end
  ...
  def test_searches
    ...
    Page.indexers[1].rebuild!
     ...
     assert_equal 240, SearchTerm.count
     ...
     # make sure that joins are created _TODO_
  ...
  def test_index_updated
    ...
    assert_equal [page], @page_term_indexer.query("discontent")      
